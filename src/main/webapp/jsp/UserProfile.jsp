...
<section>
    <div class="list">
        ...
        <div class="buttonContainer">
            <button class="btn"
                    onclick="window.Request.sendPost('ese-oye?id=UserPanel&targetUserId=${targetUserId}&postPage=${postPage-1}&newPage=1')">
            ...
            <button class="btn"
                    onclick="window.Request.sendPost('ese-oye?id=UserProfile&targetUserId=${targetUserId}&postPage=${postPage+1}&newPage=1')">
