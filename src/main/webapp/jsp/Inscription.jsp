...
<div>
    <section class="container">
        <form method="post" action="ese-oye?id=Inscription">
            ...
            <br/><br/>
            <label class="textBox">
                <input type="date" name="bday" placeholder="date de naissance " required max="08/03/2005" id="mybday"
                       onclick="btchange()">
        ...
        <input type="submit" class="btn fill" value="déjà inscrit ?"
               onclick="window.Request.sendPost('ese-oye?id=Connection')">
    </section>
