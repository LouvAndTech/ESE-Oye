...
public class JSONAssertion {
    ...
    public static void assertInstanceof(Object testedObj, Class<?> reference, String testedKey) {
        if (!reference.isInstance(testedObj))
            throw new JSONAssertionException("Object instance of condition wasn't met", testedKey, AssertionType.INSTANCE_OF, reference);
    }

    public static void assertInstanceof(Object testedObj, Class<?> reference) {
        if (!reference.isInstance(testedObj))
            throw new JSONAssertionException("Object instance of condition wasn't met", AssertionType.INSTANCE_OF, reference);
    }
