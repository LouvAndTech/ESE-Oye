...
public class FetchPostFilter {
    ...
    private final FetchOrderEnum order;
    private final float maxPrice;
    private final Set<String> keyWords;
    private final boolean mustBeValidated;
    private final String userSecureID;
    ...
    public static class Builder {
        ...
        public Builder keyWords(String... words) {
            if (words != null) Collections.addAll(this.keyWords, words);
            return this;
        }
